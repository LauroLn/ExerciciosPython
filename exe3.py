...
db=sld7["sld7"]
collection = db["turistas"]


Tela = Tk()

Tela.title("Exercicio-3")
...
def salvar():
    ...
    cadastro = {"codigo": cod, "nome": nome, "cidade": cidade, "valor": valor, "estado": estado, "guia":guia}
...
def att():
    ...
    collection.update_one({"codigo": cod }, {"$set":{"nome": nome, "cidade": cidade, "valor": valor, "estado": estado, "guia":guia}})
...
def consulta():
    ...
    if resultado:
     ...
     txt_valor.insert(END, f"{resultado["valor"]}\n")
...
lbl_cidade = Label(Tela, text="cidade: ",bg="#E0FFFF", font=("Arial",fonte)).place(x=545,y=38)
txt_valor = Entry(Tela,width=7)
txt_valor.place(x=605,y=40)

lbl_guia = Label(Tela, text="guia: ", bg="#e0ffff", font=("Arial",fonte)).place(x=180,y=78)
...
lbl_valor = Label(Tela, text="valor: ", bg="#e0ffff", font=("Arial",fonte)).place(x=430,y=80)
txt_cidade = Entry(Tela,width=7)
txt_cidade.place(x=480,y=82)

lbl_estado = Label(Tela, text="estado: ", bg="#e0ffff", font=("Arial",fonte)).place(x=535,y=82)

estados = ttk.Combobox(Tela)
estados['values']=("MG","Sp","Volks","ES")
estados.current(1)
estados.place(x=605,y=82)
